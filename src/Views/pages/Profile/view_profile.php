<?php
include CONTROLLERS.'Profile/ViewProfileController.php';
?>
...
<main>
    ...
    <script>
        function windowOpen(id) {
            ...
            window.open("<?php echo BASE_URL; ?>profile/view_resume?id=" + id, "_blank", "width=" + windowWidth + ", height=" + windowHeight + ", left=" + left + ", top=" + top);
        }
    </script>
</main>
