    ...
    <body>
        ...
        <div class="container-fluid" >
            ...
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3" >
                    <li class="nav-item" >
                        <a class="nav-link mx-lg-2<?= ($current_page == 'home.php') ? ' active' : ''; ?>"   href="home.php">Home</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link mx-lg-2<?= ($current_page == 'jobs.php') ? ' active' : ''; ?>" href="jobs.php">Jobs</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link mx-lg-2<?= ($current_page == 'top_employers.php') ? ' active' : ''; ?>" href="top_employers.php">Top Employers</a>
                    </li>
                    
                    <li class="nav-item">
                        <a class="nav-link mx-lg-2<?= ($current_page == 'find_people.php') ? ' active' : ''; ?>"  href="find_people.php">Find People</a>
                    </li>
                  
                    <li class="nav-item">
                        <a class="nav-link mx-lg-2<?= ($current_page == 'cv_genarator.php') ? ' active' : ''; ?>"  href="cv_genarator.php">CV Generator</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link mx-lg-2<?= ($current_page == 'aboutus.php') ? ' active' : ''; ?>"  href="aboutus.php">About</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link mx-lg-2<?= ($current_page == 'contactus.php') ? ' active' : ''; ?>"  href="contactus.php">Contact Us</a>
                    </li>              
                </ul>
            </div>
            </div>
                <?php if(isset($_SESSION['id'])): ?>
                    <?php if(isset($_SESSION['pro_img']) && !empty($_SESSION['pro_img'])): ?>
                        <div>
                            <img class="nav-pro_img" src="/JOBJET/UPLOADED_IMG/<?=$_SESSION['pro_img']?>" width="40" height="40" alt="Profile Image" onclick="toggleMenu()">
                    ...
                    <div class="sub-manu-wrap" id="subMenu">
                        <div class="sub-menu">
                            <div class="user-info">
                                <img class="popup_img" src="/JOBJET/UPLOADED_IMG/<?=$_SESSION['pro_img'] ?? 'profile.png'?>" alt="Profile Image">
                                <p><?= $_SESSION['full_name'] ?? '' ?></p>
                                <p1><?= $_SESSION['nick_name'] ?? '' ?></p1><br>
                                <p2><?= $_SESSION['pro_email'] ?? '' ?></p2><br>
